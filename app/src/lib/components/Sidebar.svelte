<script>
	let walletIsConnected = true;
</script>

<div class="py-4 md:py-8 md:pl-4 md:pr-8 fixed w-20 md:w-64">
	<aside class="flex flex-col items-center md:items-stretch space-y-2 md:space-y-4">
		<a href="/" class="inline-block rounded-full hover:bg-gray-100 p-3 md:self-start">
			<svg
