// https://github.com/solana-labs/wallet-adapter/blob/master/packages/core/svelte/src/walletStore.ts
// NOTE This isn't an NPM package yet so copy/pasted the src code
// into this stores/wallet dir
import type {
	Adapter,
...
function createWalletStore() {
	...
	return {
		...
		updateStatus: (walletStatus: WalletStatus) =>
			update((store) => ({ ...store, ...walletStatus })),
